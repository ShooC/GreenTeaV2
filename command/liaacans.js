...
if (isCreator) return m.reply(`Ehh maaf kamu owner bot ku :D`)
...
├│${prefix}changeitem
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️Kembali Ke Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules Bot' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
...
const listMessage = {
  text: menunyaa,
  footer: "Green Tea Bot",
  title: "━━━[ Green Tea Menu ]━━━",
...
├│${prefix}neon
└─❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️Kembali Ke Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'Rules Bot' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Creator' }, type: 1 }]
...
let buttons = [{ buttonId: 'owner', buttonText: { displayText: 'Creator' }, type: 1 }]
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/6285607831412",
"matchedText": "https://wa.me/6285607831412",
